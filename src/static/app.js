        ...
        if (details.participants.length > 0) {
          participantsSection = `
            <div class="participants-section">
              ...
              <ul class="participants-list" style="list-style-type: none; margin: 8px 0 0 0;">
                ${details.participants
                  .map(
                    (p) =>
                      `<li class="participant-item" style="display: flex; align-items: center; gap: 6px;">
                        <span class="participant-email">${p}</span>
                        <span class="delete-participant" title="Remove participant" data-activity="${encodeURIComponent(name)}" data-email="${encodeURIComponent(p)}" style="cursor:pointer;color:#c62828;font-size:18px;user-select:none;">&#128465;</span>
                      </li>`
                  )
                  .join("")}
              </ul>
